...
class GitHubRepositoryTest {
    ...
    fun searchGithub_Test() {
        ...
        `when`(gitHubApi.searchGithub(TEST_SOME_QUERY)).thenReturn(call)
        repository.searchGithub(TEST_SOME_QUERY, mock(RepositoryCallback::class.java))
        verify(gitHubApi, times(1)).searchGithub(TEST_SOME_QUERY)
    }
    ...
    fun searchGithub_TestCallback() {
        ...
        `when`(gitHubApi.searchGithub(TEST_SOME_QUERY)).thenReturn(call)
        repository.searchGithub(TEST_SOME_QUERY, gitHubRepositoryCallBack)
